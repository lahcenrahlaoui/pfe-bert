...
def load_data(dataset_str):
    ...
    for i in range(len(names)):
        with open("/content/drive/MyDrive/PFE-apidesc/data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file(
        "/content/drive/MyDrive/PFE-apidesc/data/ind.{}.test.index".format(dataset_str))
...
def load_corpus(dataset_str):
    ...
    train_idx_orig = parse_index_file(
        "/content/drive/MyDrive/PFE-apidesc/data/{}.train.index".format(dataset_str))
